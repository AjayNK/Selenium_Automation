...
public class Verify_DeleteExistingPage {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		for(WebElement element:allLinks)	
		{
			...
			{
				WebElement DestroyIcon = driver.findElement(By.xpath("//*[@id='destroy-button-page']"));
				DestroyIcon.click();
				Thread.sleep(2000);
				//click confirm button on popup window
		...
		if(flag==0)
		{
			System.out.println("Required page is NOT found in the footer to delete");
		}
